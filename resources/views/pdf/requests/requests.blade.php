            ...
            <div class="col-sm-12">
                <div class="panel panel-default invoice" id="invoice">
                    <div class="panel-body">
                        <div class="invoice-ribbon" dir="ltr">
                            <div class="ribbon-inner" >PAID</div>
                        </div>
                        <div class="row" dir="ltr">
                            <div class="col-sm-6 top-left">
                                    <img src="{{ asset('assets/image/Dar_logo.svg') }}" alt="" class="img" >
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-4 from">
                                <p class="lead marginbottom">الـــــــــــــــــــــــي</p>
                                <p></p>
                                <p></p>
                                <p>California, 94103</p>
                                <p>Phone: 415-767-3600</p>
                                <p>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="accfc3c2d8cdcfd8ecc8d5c2c3cad582cfc3c1">[email&#160;protected]</a>
                                </p>
                            </div>
                            <div class="col-xs-4 to">
                                <p class="lead marginbottom">مـــــــــــــــــــــــــن</p>
                                <p>425 Market Street</p>
                                <p>Suite 2200, San Francisco</p>
                                <p>California, 94105</p>
                                <p>Phone: 415-676-3600</p>
                                <p>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="e48e8b8c8aa4808b81ca878b89">[email&#160;protected]</a></p>
                            </div>
